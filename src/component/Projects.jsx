...
function Projects() {
  ...
  <div className="project-image">
    <img src="src/assets/prt.webp" alt="Project" />
...
<div className="project-card">
  ...
  <div className="project-image">
    <img src="src/assets/pht.jpg" alt="Project" />
...
<div className="project-card">
  ...
  <div className="project-image">
    <img src="src/assets/mntr.jpg" alt="Project" />
...
<div className="project-card">
  ...
  <div className="project-image">
    <img src="src/assets/cnsult.jpg" alt="Project" />
...
<div className="project-card">
  ...
  <div className="project-image">
    <img src="src/assets/zaitoon.jpg" alt="Project" />
...
<div className="project-card">
  ...
  <div className="project-image">
    <img src="src/assets/perfume.avif" alt="Project" />
