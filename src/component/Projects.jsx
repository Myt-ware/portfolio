...
function Projects() {
  ...
  <div className="project-image">
    <img src="src/public/prt.webp" alt="Project" />
...
<div className="project-card">
  ...
  <div className="project-image">
    <img src="src/public/pht.jpg" alt="Project" />
...
<div className="project-card">
  ...
  <div className="project-image">
    <img src="src/public/mntr.jpg" alt="Project" />
...
<div className="project-card">
  ...
  <div className="project-image">
    <img src="src/public/cnsult.jpg" alt="Project" />
...
<div className="project-card">
  ...
  <div className="project-image">
    <img src="src/public/zaitoon.jpg" alt="Project" />
...
<div className="project-card">
  ...
  <div className="project-image">
    <img src="src/public/perfume.avif" alt="Project" />
